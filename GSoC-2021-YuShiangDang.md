...
-- <span style="color:#FF3377">_Details:_</span> [Go to details on this page](#4-Provide-more-details-of-Quark’s-summary-report-in-Jadx).
...
-- <span style="color:#FF3377">_Details:_</span> [Go to details on this page](#7-Improve-UI-UX-of-Quark-integration-in-APKLab).
...
<center>Table 1.1. The comparison of four different sets</center><br>
...
<center>Figure 1.1. The line chart for the ratio of the number of rules to search times</center><br>
...
<center>Figure 3.1. Error dialog</center><br>

![](https://i.imgur.com/UfibQJ1.png)
<center>Figure 3.2. Warning dialog</center><br>
...
<center>Figure 3.3. Progress bar for Quark in Jadx</center><br>

<span style="color:#157040">___Related PRs___</span>

Jadx [PR#1203](https://github.com/skylot/jadx/pull/1203): Change Quark task to background task
Jadx [PR#1202](https://github.com/skylot/jadx/pull/1202): Add Error/Warning dialogs
...
<center>Figure 4.1. The binary overview</center><br>

![](https://i.imgur.com/p9qp2SC.gif)
<center>Figure 4.2. Jump to the source code </center><br>
...
[Go back to summary](#4-Second-Goal-Provide-more-details-of-Quark’s-summary-report-in-Jadx)
...
<center>Figure 5.1. Quark analysis report in MobSF</center><br>
...
<center>Figure 5.2. The demo for source code overview</center><br>
...
![](https://i.imgur.com/d5w5Z9I.gif)
<center>Figure 6.1. Behavior map in APKLab</center><br>

![](https://i.imgur.com/r9EwLun.png)
<center>Figure 6.2. Behavior map</center><br>
...
APKLab [Issue#140](https://github.com/APKLab/APKLab/issues/140) Quark analysis may take a long time
APKLab [Issue#141](https://github.com/APKLab/APKLab/issues/141) Quark report only shows 100% confidence activities
...
[Go back to summary](#7-Second-Goal-Improve-UI-UX-of-Quark-integration-in-APKLab)
## Acknowledgments

Thank Google, for providing such a great project.
Thank [Honeynet Project](https://www.honeynet.org) gives me the opportunity.
Thank my mentor, [KunYu Chen](https://github.com/18z), for all his sincere support and guidance.
Thank [Jadx](https://github.com/skylot/jadx), [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF), [APKLab](https://github.com/APKLab/APKLab) for helping me reach my goal.
